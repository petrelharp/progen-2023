...
\begin{poster}{
 ...
 % Eye Catcher
 { \includegraphics[height=0.12\textheight]{images/tskit_logo}
 }
 % Title
 ...
 {
  \begin{tabular}{r}
    \includegraphics[height=0.12\textheight]{images/oxford-logo.jpeg}
      \hspace{1em}
    \includegraphics[height=0.12\textheight]{images/UOSignature-STK-BLK}\\
  \end{tabular}
 }
